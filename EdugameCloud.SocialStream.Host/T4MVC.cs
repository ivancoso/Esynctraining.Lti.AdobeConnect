...
public static partial class EdugameCloudT4
{
    public static EdugameCloud.SocialStream.Host.Controllers.SocialController Social = new EdugameCloud.SocialStream.Host.Controllers.T4MVC_SocialController();
