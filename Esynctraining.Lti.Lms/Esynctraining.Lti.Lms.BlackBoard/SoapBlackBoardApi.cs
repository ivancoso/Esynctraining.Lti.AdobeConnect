...
namespace Esynctraining.Lti.Lms.BlackBoard
{
    public class SoapBlackBoardApi : ILmsAPI, IBlackBoardApi
    {
        ...
        {
            var lmsUser = licenseSettings[LmsLicenseSettingNames.AdminUsername];

            if (lmsUser != null || (bool)licenseSettings[LmsLicenseSettingNames.BlackBoardEnableProxyToolMode])
            {
                //POPOV
                string toolPassword = !licenseSettings.ContainsKey(LmsLicenseSettingNames.BlackBoardProxyToolPassword)
                                          ? licenseSettings[LmsLicenseSettingNames.AdminPassword].ToString()
                                          : licenseSettings[LmsLicenseSettingNames.BlackBoardProxyToolPassword].ToString();
                ...
                return (bool)licenseSettings[LmsLicenseSettingNames.BlackBoardEnableProxyToolMode] == true
                           ...
                           : LoginUserAndCreateAClient(out error, useSsl, lmsDomain, licenseSettings[LmsLicenseSettingNames.AdminUsername].ToString(), licenseSettings[LmsLicenseSettingNames.AdminPassword].ToString());
            }
