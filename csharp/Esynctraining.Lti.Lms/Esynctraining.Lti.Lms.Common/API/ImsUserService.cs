...
namespace Esynctraining.Lti.Lms.Common.API
{
    public class ImsUserService : LmsUserServiceBase
    {
        ...
        public override Task<OperationResultWithData<List<LmsUserDTO>>> GetUsers(Dictionary<string, object> licenseSettings, string courseId, ILtiParam extraData = null)
        {
            //if (lmsCompany == null)
