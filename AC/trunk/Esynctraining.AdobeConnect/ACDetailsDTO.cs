...
namespace Esynctraining.AdobeConnect
{
    ...
    public class ACDetailsDTO
    {
        ...
        public static readonly List<TimeZoneMap> TimeZones = new List<TimeZoneMap>()
        {
            ...
            new TimeZoneMap(47,  "Venezuela Standard Time", -(4 * 60 + 30)  ),
            ...
            new TimeZoneMap(91,  "Greenwich Standard Time", 0 ),
            ...
            new TimeZoneMap(131, "Belarus Standard Time", 2 * 60 ),
            ...
            new TimeZoneMap(171, "Azerbaijan Standard Time", 4 * 60 ),
            ...
            new TimeZoneMap(283, "Russia Time Zone 11", 12 * 60 ),
            ...
            new TimeZoneMap(310, "Samoa Standard Time", 13 * 60 ),
        };
