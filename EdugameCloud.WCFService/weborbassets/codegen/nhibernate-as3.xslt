...
************************************************************************/
    ...
    * @param name  The name of a query defined externally.
     ...
     * an <code>unsaved-value</code> attribute of the identifier property mapping.
       ...
       * @private
       */    
      public function DeleteByQueryHandler(event:ResultEvent):void
      {
       ...
       * @private
       */ 
      public function GetHandler(event:ResultEvent):void
      {        
       ...
       * @private
       */ 
      public function LoadHandler(event:ResultEvent):void
      {       
          var returnValue:Object = event.result as Object;
       ...
       * @private
       */ 
      public function SaveOrUpdateHandler(event:ResultEvent):void
      {
