...
<Project ToolsVersion="4.0" DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    ...
    <ProjectTypeGuids>{A1591282-1198-4647-A2B1-27E5FF5F6F3B};{<xsl:value-of select="codegen:getGuidForVSSolution()"/>}</ProjectTypeGuids>
...
# Visual Studio 2010
Project("{<xsl:value-of select="codegen:getGuidForVSSolution()"/>}") = "InvokerDemoApp", "InvokerDemoApp\InvokerDemoApp.csproj", "{5D17EEBE-0C48-4C47-8747-DD9F712A0CAE}"
EndProject
...
EndProject
Project("{<xsl:value-of select="codegen:getGuidForVSSolution()"/>}") = "<xsl:value-of select="$projectName"/>", "<xsl:value-of select="$projectName"/>\<xsl:value-of select="$projectName"/>.csproj", "{<xsl:value-of select="$projectGuid"/>}"
EndProject
Global
